                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-3">
                                ...
                                <select id="prodi" name="prodi" class="select2 form-select required" error="Area"
                                    ...
                                    <option value="{{ $item->nama_prodi }}" {{ session('prodi')==$item->nama_prodi ?
                                        'selected'
                                        : '' }}>
        ...
        <div class="card">
            <div class="card-header text-end">
                ...
                <button type="button" class="dt-button create-new btn btn-primary" tabindex="0"
                    aria-controls="DataTables_Table_0" type="button" onclick="DokumenMou.add()">
...
@include('page.mou.dokumen_mou.modal')


@section('scripts')
@include('page.mou.dokumen_mou.scripts')
@endsection

let DetailPertanyaan = {
    module: () => {
        return "master/detail-pertanyaan";
    },

    moduleApi: () => {
        return `api/${DetailPertanyaan.module()}`;
    },

    add: () => {
        window.location.href = url.base_url(DetailPertanyaan.module()) + "add";
    },

    ubah: (elm) => {
        let data_id = $(elm).attr("data_id");
        window.location.href =
            url.base_url(DetailPertanyaan.module()) + "ubah?id=" + data_id;
    },

    back: () => {
        window.location.href =
            url.base_url(DetailPertanyaan.module()) + "index";
    },
    ...
    getData: async () => {
        ...
        if (tableData.length > 0) {
            ...
            tableData.DataTable({
                ...
                ajax: {
                    url: url.base_url(DetailPertanyaan.moduleApi()) + `getData`,
                    type: "POST",
                    // "headers": {
                ...
                columns: [
                    ...
                    // },
                    {
                        ...
                        render: (data, type, row, meta) => {
                            let htmlAction = "";
                            if (updateAction == "1") {
                                htmlAction += `<i class="bx bx-edit" style="cursor: pointer;" data_id="${data}" onclick="DetailPertanyaan.ubah(this)"></i>`;
                            }

                            if (deleteAction == "1") {
                                htmlAction += `<i class="bx bx-trash" style="cursor: pointer;" data_id="${data}" onclick="DetailPertanyaan.delete(this, event)"></i>`;
                            }
                            return htmlAction;
                        },
                    },
    ...
    delete: (elm, e) => {
        ...
        <div class="col-12 text-center">
            <br/>
            <button class="btn btn-primary btn-sm" onclick="DetailPertanyaan.deleteConfirm(this, '${data_id}')">Ya</button>
    ...
    deleteConfirm: (elm, id) => {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: params,
            url: url.base_url(DetailPertanyaan.moduleApi()) + "delete",
    ...
    getPostData: () => {
        let data = {
            data: {
                id_pertanyaan: $("#master-pertanyaan").val(),
            },
            data_pertanyaan: DetailPertanyaan.getDataPertanyaan(),
        };
        return data;
    },
    ...
    submit: (elm, e) => {
        e.preventDefault();
        let params = DetailPertanyaan.getPostData();
        ...
        if (validation.runWithElement(form)) {
            $.ajax({
                ...
                dataType: "json",
                data: params,
                url: url.base_url(DetailPertanyaan.moduleApi()) + "submit",
                beforeSend: () => {
                ...
                success: function (resp) {
                    ...
                    if (resp.is_valid) {
                        ...
                        setTimeout(function () {
                            window.location.href =
                                url.base_url(DetailPertanyaan.module()) +
                                "index";
                        }, 1000);
                    } else {
                        bootbox.dialog({
    ...
    addItem: (elm, e) => {
        ...
        <div class="card mb-4">
          <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0"></h5>
            <small class="text-muted float-end"><i class="bx bx-trash" style="cursor: pointer;"  onclick="DetailPertanyaan.removeQuestion(this, event)" title="hapus"></i></small>
          </div>
          <div class="card-body">
            <div class="row mb-3">
              ...
              <div class="col-sm-10 texteditor">
                ...
                <div class="input-group">
                  <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="DetailPertanyaan.addFile(this,'file')">Pilih</button>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-6 col-xs-6">
                    <div class="input-group">
                      <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="DetailPertanyaan.addFile(this,'file_ja_1')">Pilih</button>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-xs-6">
                    <div class="input-group">
                      <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="DetailPertanyaan.addFile(this,'file_ja_2')">Pilih</button>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-xs-6">
                    <div class="input-group">
                      <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="DetailPertanyaan.addFile(this,'file_ja_3')">Pilih</button>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-xs-6">
                    <div class="input-group">
                      <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="DetailPertanyaan.addFile(this,'file_ja_4')">Pilih</button>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                ...
                <input type="number" onkeypress="return DetailPertanyaan.isNumber(event)"  class="form-control required" id="bobot" name="bobot" placeholder="Bobot" error="Bobot">
              </div>
            </div>
            <div class="row mb-3">
        ...
        DetailPertanyaan.setTextEditor();

        // DetailPertanyaan.select2All();
    },
    ...
    setTextEditor: () => {
        ...
        // let dataTexteditor = $('.text-editor');
        // $.each(dataTexteditor, function () {
        //     tinymce.init({
...
$(function () {
    DetailPertanyaan.getData();
    DetailPertanyaan.setDate();
    DetailPertanyaan.setTextEditor();
    DetailPertanyaan.select2All();
});

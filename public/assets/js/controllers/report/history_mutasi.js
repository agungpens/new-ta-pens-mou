        ...
        if (tableData.length > 0) {
            ...
            tableData.DataTable({
                ...
                "columns": [{
                    ...
                    //             htmlAction += `<i class="bx bx-edit" style="cursor: pointer;" data_id="${data}" onclick="Karyawan.ubah(this)"></i>`;
                    //         }
                            
                    //         if(deleteAction == '1' && row.approve_gm != '0'){
                    //             htmlAction += `<i class="bx bx-trash" style="cursor: pointer;" data_id="${data}" onclick="Karyawan.delete(this, event)"></i>`;
                    //         }                     
                            
                    //         if(row.approve_gm == '0' || row.approve_gm == '2'){
                    //             htmlAction += `<i class="bx bx-notepad" style="cursor: pointer;" data_id="${data}" onclick="Karyawan.showPengajuanData(this, event)"></i>`;
                    //         }
                    //         return htmlAction;
                    //     }
                    // }
